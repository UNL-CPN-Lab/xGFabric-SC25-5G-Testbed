...
def add_user(imsi, key="00112233445566778899aabbccddeeff", op=None,
             opc="63bfa50ee6523365ff14c1f45f88737d", amf="9001", apn="srsapn", qci="9", ip_alloc="", sst=1, sd=""):
...
def read_from_string(sub_data):
    ...
    subscriber_db.append({"imsi": imsi, "key": key, "op": op,
                          "opc": opc, "amf": amf, "qci": qci, "ip_alloc": ip_alloc.rstrip(), "sst":int(sst), "sd":sd})

    return subscriber_db

# def parse_args():
#     parser = argparse.ArgumentParser(description="")
#     parser.add_argument("-d", "--data", choices=["data"], help="subscriber data")
